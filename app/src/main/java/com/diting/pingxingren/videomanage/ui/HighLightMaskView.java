package com.diting.pingxingren.videomanage.ui;
...
public class HighLightMaskView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = MeasureSpec.getSize(MeasureSpec.makeMeasureSpec(ScreenUtil.getScreenWidth(getContext()), MeasureSpec.EXACTLY));
        int height = MeasureSpec.getSize(MeasureSpec.makeMeasureSpec(ScreenUtil.getScreenHeight(getContext()), MeasureSpec.EXACTLY));
    ...
    public void setStartAndEndY(View currentItemView) {
        ...
        loc[1] = loc[1] - ScreenUtil.getStatusBarHeight(getContext());
        this.mStartY = loc[1];
