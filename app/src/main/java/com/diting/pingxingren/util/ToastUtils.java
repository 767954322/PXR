...
public class ToastUtils {
     ...
     *                       {@code true}: 弹出新吐司<br>{@code false}: 只修改文本内容
    ...
    private static void showToast(int resId, int duration) {
        showToast(MyApplication.getInstance().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(int resId, int duration, Object... args) {
        showToast(String.format(MyApplication.getInstance().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null)
            sToast = Toast.makeText(MyApplication.getInstance().getApplicationContext(), text, duration);
